...
final class DeviceClassificationAdvancedTests: XCTestCase {
    func testRaspberryPiHostname() async {
    ...
    func testChromecastService() async {
    ...
    func testHomePodAudioOnly() async {
    ...
    func testSmartPlugTPLink() async {
    ...
    func testHomeKitSingleServiceAccessory() async {
